...
Int_t    baseTree::CutSignalR(Long64_t entry){
    if (CutPreselection(entry)>0 && pidfsi>0.05 && veract*7.6634e-2<50 && pidfsi1prescor>-0.05 && pidfsiccqecor<0.0 && GetQsq(GetPrec(range)*1.e3,muang_t)/1.e6<0.15) {//opt1, opt2, final
        return 1;
    }
    else return -1;
}
Int_t    baseTree::CutCR1(Long64_t entry){
    ...
    if (CutPreselection(entry)>0 && !(pidfsi>0.05) && veract*7.6634e-2<50 && pidfsi1prescor>-0.05 && pidfsiccqecor<0.0 && GetQsq(GetPrec(range)*1.e3,muang_t)/1.e6<0.15) {//opt9, final
...
Int_t    baseTree::CutCR23Comb(Long64_t entry){
    if (Ntrack>2 && pang<90 && pidfsi1prescor>-0.05 && pidfsiccqecor<0.0 && !(mufc==0 && pene<9) && GetQsq(GetPrec(range)*1.e3,muang_t)/1.e6<0.15 && veract*7.6634e-2<50) {//final
...
Int_t    baseTree::CutCR1NonVeract(Long64_t entry){
    ...
    if (CutPreselection(entry)>0 && veract*7.6634e-2>50 && pidfsi1prescor>-0.05 && pidfsiccqecor<0.0 && GetQsq(GetPrec(range)*1.e3,muang_t)/1.e6<0.15) {//opt9, final
...
Int_t baseTree::CutTopologybyID(Long64_t entry, Int_t topoID)
{
    ...
    //presel + other pid
        ...
        if (CutPreselection(entry)>0 && pidfsi1prescor>-0.05 && pidfsiccqecor<0.0) return 1;
        else return -1;
    }
    //presel + other pid+ Qsq
    else if (topoID==8) {
        if (CutPreselection(entry)>0 && pidfsi1prescor>-0.05 && pidfsiccqecor<0.0 && GetQsq(GetPrec(range)*1.e3,muang_t)/1.e6<0.15) return 1;
        else return -1;
    }
    //presel + other pid + veract
    else if (topoID==9) {
        if (CutPreselection(entry)>0 && pidfsi1prescor>-0.05 && pidfsiccqecor<0.0 && veract*7.6634e-2<50) return 1;
        else return -1;
    }
    //presel + other pid + Qsq + veract
    else if (topoID==10) {
        if (CutPreselection(entry)>0 && pidfsi1prescor>-0.05 && pidfsiccqecor<0.0 && GetQsq(GetPrec(range)*1.e3,muang_t)/1.e6<0.15 && veract*7.6634e-2<50) return 1;
        else return -1;
    }
    ...
    //m2trk presel + other pid
        ...
        if (Ntrack>2  && pang<90 && !(mufc==0 && pene<9) && pidfsi1prescor>-0.05 && pidfsiccqecor<0.0 ) return 1;
        else return -1;
    }
    //m2trk presel + other pid + veract
    else if (topoID==16) {
        if (Ntrack>2 && pang<90 && !(mufc==0 && pene<9) && pidfsi1prescor>-0.05 && pidfsiccqecor<0.0 && veract*7.6634e-2<50) return 1;
        else return -1;
    }
    //m2trk presel + other pid + Qsq
    else if (topoID==17) {
        if (Ntrack>2 && pang<90 && !(mufc==0 && pene<9) && pidfsi1prescor>-0.05 && pidfsiccqecor<0.0 && GetQsq(GetPrec(range)*1.e3,muang_t)/1.e6<0.15) return 1;
        else return -1;
    }
    
    //m2trk presel + other pid + nonveract+ Qsq
    else if (topoID==18) {
        if (Ntrack>2 && pang<90 && !(mufc==0 && pene<9) && pidfsi1prescor>-0.05 && pidfsiccqecor<0.0 && GetQsq(GetPrec(range)*1.e3,muang_t)/1.e6<0.1 && veract*7.6634e-2>50) return 1;
        else return -1;
    }
    //cr1 but nonveract
    else if (topoID==19) {
    ...
    //cr2 but non veract
        ...
        if (CutCR23CombNonVeract(entry)>0 && pidfsi>0.05 && veract*7.6634e-2<120) return 1;
        else return -1;
    }
    
    //cr1||cr2 but non veract 
    else if (topoID==21) {
        if ((CutCR1NonVeract(entry)>0 || CutCR23CombNonVeract(entry)>0) && pidfsi>0.05 && veract*7.6634e-2<120) return 1;
        else return -1;
    }
...
Int_t    baseTree::GetSampleType(Long64_t entry){
    ...
    else if (CutCR1(entry)>0) return 2;
    else if (CutCR23Comb(entry)>0) return 3;
