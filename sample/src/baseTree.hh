...
Int_t    baseTree::CutSignalR(Long64_t entry){
    if (CutPreselection(entry)>0 && pidfsi>0.05 && veract*7.6634e-2<60 /*&& pidfsi1prescor>-0.1 && pidfsiccqecor<0.1 && GetQsq(GetPrec(range)*1.e3,muang_t)/1.e6<0.15*/) {//opt1, opt2, final
        return 1;
    }
    else return -1;
}
Int_t    baseTree::CutCR1(Long64_t entry){
    ...
    if (CutPreselection(entry)>0 && !(pidfsi>0.05) && veract*7.6634e-2<60 /*&& pidfsi1prescor>-0.1 && pidfsiccqecor<0.1 && GetQsq(GetPrec(range)*1.e3,muang_t)/1.e6<0.15*/) {//opt9, final
...
Int_t    baseTree::CutCR23Comb(Long64_t entry){
    if (Ntrack>2 && pang<90 /*&& pidfsi1prescor>-0.1 && pidfsiccqecor<0.1*/ && !(mufc==0 && pene<9) /*&& GetQsq(GetPrec(range)*1.e3,muang_t)/1.e6<0.15*/ && veract*7.6634e-2<60) {//final
...
Int_t    baseTree::CutCR1NonVeract(Long64_t entry){
    ...
    if (CutPreselection(entry)>0 && veract*7.6634e-2>60 && pidfsi1prescor>-0.1 && pidfsiccqecor<0.1 && GetQsq(GetPrec(range)*1.e3,muang_t)/1.e6<0.15) {//opt9, final
...
Int_t baseTree::CutTopologybyID(Long64_t entry, Int_t topoID)
{
    ...
    //presel + other pid + veract
        ...
        if (CutPreselection(entry)>0 && pidfsi1prescor>-0.1 && pidfsiccqecor<0.1 && veract*7.6634e-2<60) return 1;
        else return -1;
    }
    //presel + other pid + Qsq + veract
    else if (topoID==10) {
        if (CutPreselection(entry)>0 && pidfsi1prescor>-0.1 && pidfsiccqecor<0.1 && GetQsq(GetPrec(range)*1.e3,muang_t)/1.e6<0.15 && veract*7.6634e-2<60) return 1;
        else return -1;
    }
    ...
    //presel + veract
        ...
        if (CutPreselection(entry)>0 && veract*7.6634e-2<60) return 1;
        else return -1;
    }
    //presel + Qsq
    else if (topoID==13) {
    ...
    //m2trk presel
        ...
        if (Ntrack>2 && pang<90 && !(mufc==0 && pene<9) && veract*7.6634e-2<60) return 1;
        else return -1;
    }
    
    //m2trk presel + other pid
    else if (topoID==15) {
        if (Ntrack>2  && pang<90 && !(mufc==0 && pene<9) && veract*7.6634e-2<60 && pidfsi>0.05) return 1;
        else return -1;
    }
    //m2trk presel + other pid + veract
    else if (topoID==16) {
        if (Ntrack>2 && pang<90 && !(mufc==0 && pene<9) && pidfsi1prescor>-0.1 && pidfsiccqecor<0.1 && veract*7.6634e-2<60) return 1;
        else return -1;
    }
    ...
    //m2trk presel + other pid + nonveract+ Qsq
        ...
        if (Ntrack>2 && pang<90 && !(mufc==0 && pene<9) && pidfsi1prescor>-0.1 && pidfsiccqecor<0.1 && GetQsq(GetPrec(range)*1.e3,muang_t)/1.e6<0.15 && veract*7.6634e-2>60) return 1;
        else return -1;
    }
    //cr1 but nonveract
    else if (topoID==19) {
    ...
    //cr1||cr2 but non veract 
        ...
        if ((CutCR1NonVeract(entry)>0 || CutCR23CombNonVeract(entry)>0) && pidfsi>0.05) return 1;
    ...
    //2trk 1mu + 1pi + nonveract
        ...
        if (Ntrack==2 && Ningtrack==1 && mumucl>0.6 && pmucl>0.6 && veract*7.6634e-2>60) return 1;
        else return -1;
    }
